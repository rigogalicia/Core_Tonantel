...
@NamedQueries({
    @NamedQuery(name = "GcVentajas.findAll", query = "SELECT g FROM GcVentajas g")})
public class GcVentajas implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GcVentajas)) {
            return false;
        }
        GcVentajas other = (GcVentajas) object;
